...
export function BeerModal({ onConfirm, onClose }: { onConfirm?: (items: SelectedItem[]) => void; onClose?: () => void }) {
              ...
              <tr style={{ background: "#fff", animation: "fadeInUp 0.3s ease 0.2s both" }}>
                ...
                <td style={{ ...styles.td, ...styles.tdLabel }} colSpan={2}>
                  <div style={styles.addRow}>
                    <input style={styles.addInput} type="text" placeholder="+ Add a specific beer..." value={customInput} onChange={(e) => setCustomInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && addCustomItem()} />
