...
export function WineModal({ onConfirm, onClose }: { onConfirm?: (items: SelectedItem[]) => void; onClose?: () => void }) {
  const [items, setItems] = useState<Item[]>([
    { id: "red", label: "Red Wine", qty: 0, selected: false },
    { id: "white", label: "White Wine", qty: 0, selected: false },
    { id: "rose", label: "Rosé", qty: 0, selected: false },
    { id: "prosecco", label: "Prosecco", qty: 0, selected: false },
    { id: "champagne", label: "Champagne", qty: 0, selected: false },
    { id: "sparkling", label: "Sparkling Wine", qty: 0, selected: false },
    { id: "dessert", label: "Dessert Wine", qty: 0, selected: false },
  ]);
    ...
    <div className="modal-backdrop" style={styles.overlay}>
      <div className="modal-content" style={styles.modal}>
        <div style={styles.header}>
          <div>
            <h2 style={styles.heading}>Wine — what do you carry?</h2>
          ...
          <table style={styles.table}>
            <thead>
              <tr style={{ animation: "fadeInDown 0.3s ease" }}>
                ...
                <th style={{ ...styles.th, textAlign: "left" }}>Wine</th>
              ...
              <tr style={{ background: "#fff", animation: "fadeInUp 0.3s ease 0.2s both" }}>
                ...
                <td style={{ ...styles.td, ...styles.tdLabel }} colSpan={2}>
                  <div style={styles.addRow}>
                    <input style={styles.addInput} type="text" placeholder="+ Add a specific wine..." value={customInput} onChange={(e) => setCustomInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && addCustomItem()} />
