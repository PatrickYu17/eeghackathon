...
export function MixersModal({ onConfirm, onClose }: { onConfirm?: (items: SelectedItem[]) => void; onClose?: () => void }) {
  const [items, setItems] = useState([
    { id: "soda_water", label: "Soda Water", qty: 0, selected: false },
    { id: "tonic", label: "Tonic Water", qty: 0, selected: false },
    { id: "ginger_beer", label: "Ginger Beer", qty: 0, selected: false },
    { id: "oj", label: "Orange Juice", qty: 0, selected: false },
    { id: "cranberry", label: "Cranberry Juice", qty: 0, selected: false },
    { id: "pineapple", label: "Pineapple Juice", qty: 0, selected: false },
    { id: "lime", label: "Lime Juice", qty: 0, selected: false },
    { id: "grenadine", label: "Grenadine", qty: 0, selected: false },
  ]);
    ...
    <div className="modal-backdrop" style={styles.overlay}>
      <div className="modal-content" style={styles.modal}>
        <div style={styles.header}>
          <div>
            <h2 style={styles.heading}>Mixers — what do you carry?</h2>
          ...
          <table style={styles.table}>
            <thead>
              <tr style={{ animation: "fadeInDown 0.3s ease" }}>
                ...
                <th style={{ ...styles.th, textAlign: "left" }}>Mixer</th>
              ...
              <tr style={{ background: "#fff", animation: "fadeInUp 0.3s ease 0.2s both" }}>
                ...
                <td style={{ ...styles.td, ...styles.tdLabel }} colSpan={2}>
                  <div style={styles.addRow}>
                    <input style={styles.addInput} type="text" placeholder="+ Add a specific mixer..." value={customInput} onChange={(e) => setCustomInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && addCustomItem()} />
